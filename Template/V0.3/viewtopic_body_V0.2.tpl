            ...
            <div class="post_avatar">
              ...
              <div id="post_avatar_infos">
                ...
                <div id="post_avatar_tableau">
                  <div id="post_avatar_dollars"><!-- BEGIN profile_field --><div id="field_id{profile_field.ID}">{postrow.displayed.profile_field.CONTENT} </div><!-- END profile_field --><span>crédits</span></div>
